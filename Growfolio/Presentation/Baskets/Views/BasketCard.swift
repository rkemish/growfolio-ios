            ...
            HStack(spacing: 20) {
                VStack(alignment: .leading, spacing: 4) {
                    Text("Value")
                        .font(.caption)
                        .foregroundStyle(.secondary)
                    Text(basket.summary.currentValue.currencyFormatted)
                        .font(.title3)
                        .fontWeight(.semibold)
                }
                ...
                VStack(alignment: .leading, spacing: 4) {
                    Text("Gain/Loss")
                        .font(.caption)
                        .foregroundStyle(.secondary)
                    Text(basket.summary.totalGainLoss.currencyFormatted)
                        .font(.title3)
                        .fontWeight(.semibold)
                ...
                VStack(alignment: .trailing, spacing: 4) {
                    Text("Return")
                        .font(.caption)
                        .foregroundStyle(.secondary)
                    Text(basket.summary.returnPercentage.percentageFormatted)
                        .font(.title3)
                        .fontWeight(.semibold)
                        .foregroundStyle(gainLossColor)
                }
